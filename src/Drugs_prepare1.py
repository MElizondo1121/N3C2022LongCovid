...
@transform_pandas(
    Output(rid="ri.foundry.main.dataset.02811c02-f7c8-41b5-96ac-d80a44729fdf"),
    Drugs=Input(rid="ri.foundry.main.dataset.0aede4a5-11f0-4012-9570-a09e2e26bb17")
)
def Drugs_prepare1(Drugs):
    ...
    df = df.withColumn('Zolpidem_drug', when(col('drug_concept_name') == 'zolpidem tartrate 5 MG Oral Tablet',col('drug_exposure_duration')))

    df = df.withColumn('Other_drug', when((col('drug_concept_name').isin(drug_ids) ==False), col('drug_exposure_duration')))
